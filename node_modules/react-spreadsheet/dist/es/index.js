...
var enhance$3 = function (CornerIndicatorComponent) {
    return function CornerIndicatorWrapper(props) {
        ...
        var selectEntireWorksheet$1 = React.useCallback(function () { return dispatch(selectEntireWorksheet()); }, [dispatch]);
        var selected = useSelector(function (state) { return state.selected instanceof EntireWorksheetSelection; });
        return (React.createElement(CornerIndicatorComponent, __assign({}, props, { selected: selected, onSelect: selectEntireWorksheet$1 })));
    };
};
...
var DataViewer = function (_a) {
    ...
    return typeof value === "boolean" ? (React.createElement("span", { className: "Spreadsheet__data-viewer Spreadsheet__data-viewer--boolean" }, convertBooleanToText(value))) : (React.createElement("span", { className: classNames("Spreadsheet__data-viewer", {
...
var Spreadsheet = function (props, ref) {
    ...
    React.useImperativeHandle(ref, function () { return methods; });
    // Track active
...
var Spreadsheet$1 = React.forwardRef(Spreadsheet);

export { DataEditor, DataViewer, EmptySelection, EntireAxisSelection, EntireColumnsSelection, EntireRowsSelection, EntireSelection, EntireWorksheetSelection, InvalidIndexError, Model, PointRange, RangeSelection, Selection, Spreadsheet$1 as Spreadsheet, createEmpty as createEmptyMatrix, createFormulaParser, Spreadsheet$1 as default };
