...
var PointGraph = /** @class */ (function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    ...
                    values_1 = (e_5 = void 0, __values(values)), values_1_1 = values_1.next();
                    _f.label = 5;
                case 5:
                    if (!!values_1_1.done) return [3 /*break*/, 8];
                    value = values_1_1.value;
                    hash = toString(value);
                    if (!(!visitedHashes.has(hash) && !this.forwards.has(hash))) return [3 /*break*/, 7];
    ...
    PointGraph.prototype.traverseBFSBackwards = function () {
        var visited, queue, _a, _b, _c, point, values, point, dependents, dependents_2, dependents_2_1, dependent;
        var e_7, _d, e_8, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
...
function evaluateCell(prevEvaluatedData, data, referenceGraph, point, cell, formulaParser) {
    ...
    if (referenceGraph.hasCircularDependency(point)) {
        ...
        var nextEvaluatedData_1 = set(point, __assign(__assign({}, cell), { value: FormulaParser.FormulaError.REF }), prevEvaluatedData);
        try {
            for (var _c = __values(referenceGraph.getBackwardsRecursive(point)), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                nextEvaluatedData_1 = set(referrer, __assign(__assign({}, referrerCell), { value: FormulaParser.FormulaError.REF }), nextEvaluatedData_1);
            }
        }
        catch (e_1_1) { e_1 = { error: e_1_1 }; }
        finally {
...
function getFormulaComputedValue(value, point, formulaParser) {
    ...
    try {
        ...
        return FormulaParser.FormulaError.REF;
    }
}
...
function reducer(state, action) {
    ...
    switch (action.type) {
        ...
        case SET_SELECTION: {
            ...
            var active = state.active && selection.has(state.model.data, state.active)
                ? state.active
                : range === null || range === void 0 ? void 0 : range.start;
...
var shiftKeyDownHandlers = {
    ArrowUp: function (state) { return (__assign(__assign({}, state), { selected: modifyEdge(state.selected, state.active, state.model.data, Direction.Top) })); },
    ArrowDown: function (state) { return (__assign(__assign({}, state), { selected: modifyEdge(state.selected, state.active, state.model.data, Direction.Bottom) })); },
    ArrowLeft: function (state) { return (__assign(__assign({}, state), { selected: modifyEdge(state.selected, state.active, state.model.data, Direction.Left) })); },
    ArrowRight: function (state) { return (__assign(__assign({}, state), { selected: modifyEdge(state.selected, state.active, state.model.data, Direction.Right) })); },
    Tab: go(0, -1),
};
...
var CornerIndicator = function (_a) {
    ...
    return (React__namespace.createElement("th", { className: classNames("Spreadsheet__header", {
...
var enhance$3 = function (CornerIndicatorComponent) {
    return function CornerIndicatorWrapper(props) {
        ...
        var selectEntireWorksheet$1 = React__namespace.useCallback(function () { return dispatch(selectEntireWorksheet()); }, [dispatch]);
        var selected = useSelector(function (state) { return state.selected instanceof EntireWorksheetSelection; });
        return (React__namespace.createElement(CornerIndicatorComponent, __assign({}, props, { selected: selected, onSelect: selectEntireWorksheet$1 })));
    };
};
...
var Cell = function (_a) {
    ...
    var point = React__namespace.useMemo(function () { return ({
        row: row,
        column: column,
    }); }, [row, column]);
    ...
    return (React__namespace.createElement("td", { ref: rootRef, className: classNames("Spreadsheet__cell", data === null || data === void 0 ? void 0 : data.className, {
        ...
        React__namespace.createElement(DataViewer, { row: row, column: column, cell: data, evaluatedCell: evaluatedData, setCellData: setCellData })));
};
var enhance = function (CellComponent) {
    return function CellWrapper(props) {
        ...
        var setCellData$1 = React__namespace.useCallback(function (data) { return dispatch(setCellData(point, data)); }, [dispatch, point]);
        ...
        return (React__namespace.createElement(CellComponent, __assign({}, props, { selected: selected, active: active, copied: copied, dragging: dragging, mode: mode, evaluatedData: evaluatedData, data: data, select: select$1, activate: activate$1, setCellDimensions: setCellDimensions$1, setCellData: setCellData$1 })));
    };
};
...
var ActiveCell = function (props) {
    ...
    return hidden ? null : (React__namespace.createElement("div", { ref: rootRef, className: classNames("Spreadsheet__active-cell", "Spreadsheet__active-cell--".concat(mode)), style: dimensions, onClick: mode === "view" && !readOnly ? edit : undefined, tabIndex: 0 }, mode === "edit" && active && (React__namespace.createElement(DataEditor, { row: active.row, column: active.column, cell: cell, 
        // @ts-ignore
...
var FloatingRect = function (_a) {
    ...
    return (React__namespace.createElement("div", { className: classNames("Spreadsheet__floating-rect", (_b = {},
 ...
 */
var Spreadsheet = function (props, ref) {
    var _a;
    var className = props.className, darkMode = props.darkMode, columnLabels = props.columnLabels, rowLabels = props.rowLabels, hideColumnIndicators = props.hideColumnIndicators, hideRowIndicators = props.hideRowIndicators, onKeyDown = props.onKeyDown, _b = props.Table, Table$1 = _b === void 0 ? Table : _b, _c = props.Row, Row$1 = _c === void 0 ? Row : _c, _d = props.HeaderRow, HeaderRow$1 = _d === void 0 ? HeaderRow : _d, _e = props.DataEditor, DataEditor$1 = _e === void 0 ? DataEditor : _e, _f = props.DataViewer, DataViewer$1 = _f === void 0 ? DataViewer : _f, _g = props.onChange, onChange = _g === void 0 ? function () { } : _g, _h = props.onModeChange, onModeChange = _h === void 0 ? function () { } : _h, _j = props.onSelect, onSelect = _j === void 0 ? function () { } : _j, _k = props.onActivate, onActivate = _k === void 0 ? function () { } : _k, _l = props.onBlur, onBlur = _l === void 0 ? function () { } : _l, _m = props.onCellCommit, onCellCommit = _m === void 0 ? function () { } : _m, _o = props.onEvaluatedDataChange, onEvaluatedDataChange = _o === void 0 ? function () { } : _o;
    var initialState = React__namespace.useMemo(function () {
        var createParser = (props.createFormulaParser ||
            createFormulaParser);
        var model = new Model(createParser, props.data);
        return __assign(__assign({}, INITIAL_STATE), { model: model, selected: props.selected || INITIAL_STATE.selected });
    ...
    var blur = useAction(blur$1);
    var setSelection$1 = useAction(setSelection);
    var activate$1 = useAction(activate);
    // Memoize methods to be exposed via ref
    var methods = React__namespace.useMemo(function () { return ({
        activate: function (point) {
            activate$1(point);
        },
    }); }, []);
    // Expose methods to parent via ref
    React__namespace.useImperativeHandle(ref, function () { return methods; });
    // Track active
    var prevActiveRef = React__namespace.useRef(state.active);
    React__namespace.useEffect(function () {
    ...
    var prevDataRef = React__namespace.useRef(state.model.data);
    React__namespace.useEffect(function () {
    ...
    var prevEvaluatedDataRef = React__namespace.useRef(state.model.evaluatedData);
    React__namespace.useEffect(function () {
        var _a, _b;
        if (((_a = state === null || state === void 0 ? void 0 : state.model) === null || _a === void 0 ? void 0 : _a.evaluatedData) !== (prevEvaluatedDataRef === null || prevEvaluatedDataRef === void 0 ? void 0 : prevEvaluatedDataRef.current)) {
            onEvaluatedDataChange((_b = state === null || state === void 0 ? void 0 : state.model) === null || _b === void 0 ? void 0 : _b.evaluatedData);
        }
    ...
    var prevSelectedRef = React__namespace.useRef(state.selected);
    React__namespace.useEffect(function () {
    ...
    var prevModeRef = React__namespace.useRef(state.mode);
    React__namespace.useEffect(function () {
    ...
    var prevLastCommitRef = React__namespace.useRef(state.lastCommit);
    React__namespace.useEffect(function () {
        var e_1, _a;
    ...
    var prevSelectedPropRef = React__namespace.useRef(props.selected);
    React__namespace.useEffect(function () {
        if (props.selected &&
    ...
    var prevDataPropRef = React__namespace.useRef(props.data);
    React__namespace.useEffect(function () {
    ...
    var prevCreateFormulaParserPropRef = React__namespace.useRef(props.createFormulaParser);
    React__namespace.useEffect(function () {
        if (props.createFormulaParser !== prevCreateFormulaParserPropRef.current &&
    ...
    var writeDataToClipboard = React__namespace.useCallback(function (event) {
    ...
    var tableNode = React__namespace.useMemo(function () { return (React__namespace.createElement(Table$1, { columns: size.columns, hideColumnIndicators: hideColumnIndicators },
        React__namespace.createElement(HeaderRow$1, null,
            ...
            !hideColumnIndicators &&
                range(size.columns).map(function (columnNumber) {
                    return columnLabels ? (React__namespace.createElement(ColumnIndicator$1, { key: columnNumber, column: columnNumber, label: columnNumber in columnLabels
                            ? columnLabels[columnNumber]
                            : null })) : (React__namespace.createElement(ColumnIndicator$1, { key: columnNumber, column: columnNumber }));
                })),
        range(size.rows).map(function (rowNumber) { return (React__namespace.createElement(Row$1, { key: rowNumber, row: rowNumber },
            !hideRowIndicators &&
            ...
            range(size.columns).map(function (columnNumber) { return (React__namespace.createElement(Cell$1, { key: columnNumber, row: rowNumber, column: columnNumber, 
                // @ts-ignore
    ...
    var activeCellNode = React__namespace.useMemo(function () { return (React__namespace.createElement(ActiveCell
    // @ts-ignore
    , { 
        // @ts-ignore
        DataEditor: DataEditor$1 })); }, [DataEditor$1]);
    var rootNode = React__namespace.useMemo(function () { return (React__namespace.createElement("div", { ref: rootRef, className: classNames("Spreadsheet", className, {
...
var Spreadsheet$1 = React__namespace.forwardRef(Spreadsheet);

exports.DataEditor = DataEditor;
exports.DataViewer = DataViewer;
exports.EmptySelection = EmptySelection;
exports.EntireAxisSelection = EntireAxisSelection;
exports.EntireColumnsSelection = EntireColumnsSelection;
